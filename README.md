...
````carousel
![Vista Principal](laura-restaurant/vellutoreservas.png)
<!-- slide -->
![Hero Interior](laura-restaurant/src/assets/hero_interior.png)
<!-- slide -->
![Ambiente del Restaurante](laura-restaurant/src/assets/restaurant_ambiance.jpg.png)
<!-- slide -->
![Sección de Reservas](laura-restaurant/src/assets/reservation_bg.png)
````
...
![Workflow de Reservas en n8n](n8n-workflow.png)
